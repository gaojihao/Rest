...
export default {
  ...
  data() {
    return {
      ...
      data: [{ name: 'vue-admin-', timestamp: new Date(), threadName: 'system-prompt-message', level: 'INFO', className: 'me.zhengjie.AppRun' + ' :', body: 'Welcome, no log output' }],
      // level
